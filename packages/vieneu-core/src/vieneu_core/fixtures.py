...
def make_synthesize_request(**overrides) -> SynthesizeRequest:
    ...
    defaults = dict(
        text="Xin chào, đây là đoạn thử nghiệm.",
        voice_id="Minh Đức",
        style=None,
        rate=1.0,
        ref_audio_path=None,
    ...
    return SynthesizeRequest(**defaults)
...
def make_capabilities(**overrides) -> Capabilities:
    ...
    return Capabilities(
        supports_preset_voices=overrides.pop("supports_preset_voices", base.supports_preset_voices),
        supports_voice_cloning=overrides.pop("supports_voice_cloning", base.supports_voice_cloning),
        ...
        supports_emotion_tags=overrides.pop("supports_emotion_tags", base.supports_emotion_tags),
